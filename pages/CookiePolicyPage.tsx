        ...
        <div className="min-h-screen bg-transparent pt-32 px-6 pb-24">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mb-12 pb-8 border-b border-slate-800">
                    <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-4">Çerez Politikası</h1>
                    <p className="text-slate-400">Son Güncelleme: 24 Ekim 2023</p>
                </div>
                ...
                <div className="prose prose-invert prose-lg max-w-none text-slate-300">
                    ...
                    <h3 className="text-white font-bold text-2xl mt-12 mb-4">1. Çerezler Nedir?</h3>
                    <p>
                    ...
                    <h3 className="text-white font-bold text-2xl mt-12 mb-4">2. Çerezleri Nasıl Kullanıyoruz</h3>
                    <p>
                    ...
                    <h3 className="text-white font-bold text-2xl mt-12 mb-6">3. Kullandığımız Çerezler</h3>
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse border border-slate-700 text-sm font-mono">
                            <thead className="bg-slate-900">
                                <tr>
                                    <th className="border border-slate-700 p-4 text-white">İsim</th>
                                    <th className="border border-slate-700 p-4 text-white">Tür</th>
                                    <th className="border border-slate-700 p-4 text-white">Süre</th>
                                    <th className="border border-slate-700 p-4 text-white">Amaç</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td className="border border-slate-700 p-4">_session_id</td>
                                    <td className="border border-slate-700 p-4">Zorunlu</td>
                                    <td className="border border-slate-700 p-4">Oturum</td>
                                    <td className="border border-slate-700 p-4">Kullanıcı oturum durumunu korur.</td>
                                </tr>
                                <tr>
                                    <td className="border border-slate-700 p-4">_ga</td>
                                    <td className="border border-slate-700 p-4">Analitik</td>
                                    <td className="border border-slate-700 p-4">2 yıl</td>
                                    <td className="border border-slate-700 p-4">Google Analytics tarafından kullanıcıları ayırt etmek için kullanılır.</td>
                                </tr>
                                <tr>
                                    <td className="border border-slate-700 p-4">cookie_consent</td>
                                    <td className="border border-slate-700 p-4">İşlevsel</td>
                                    <td className="border border-slate-700 p-4">1 yıl</td>
                                    <td className="border border-slate-700 p-4">Çerez izni tercihlerinizi saklar.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

                    <h3 className="text-white font-bold text-2xl mt-12 mb-4">4. Çerezleri Yönetme</h3>
                    <p>
